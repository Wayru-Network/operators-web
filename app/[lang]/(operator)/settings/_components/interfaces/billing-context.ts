...
import { subscriptions } from "@/lib/generated/prisma";
import { PricingResponse } from "@/lib/services/pricing-services";

export interface BillingProviderProps {
  children: React.ReactNode;
  subscription: subscriptions | null;
  pricings: PricingResponse | null;
  hotspots: Hotspot[];
}
...
export type BillingContextType = {
  /**
   * Subscription information of the customer
   */
  subscription: subscriptions | null;
  /**
   * Premium features obtained from our database
   */
  pricings: PricingResponse | null;
  /**
   * Update the selection of premium features
   */
  //handlePremiumFeaturesChange: (features: subscription_addon[]) => void;
  /**
