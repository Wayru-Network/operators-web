...
import {
  ...
  Period,
} from "./_services/get-hotspots-analytics";
    ...
    <div>
      ...
      <div className="w-full h-full bg-[#ffffff] dark:bg-[#191c1d] rounded-[30px] my-2 p-10">
        ...
        <div className="flex gap-2 mt-8">
          <AnalyticCard title="Hotspots" value={totalHotspots.toString()} />
          <AnalyticCard
            title="Data traffic"
            value={dataTraffic.toString()}
            unit={unit}
          />
          <AnalyticCard title="Connections" value={connections.toString()} />
        </div>
